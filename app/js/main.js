...
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_0__["default"])('.contacts-us__form', contactsUsRules, afterForm);
...
const validateForms = (selector, rules, afterSend) => {
  ...
  if (telSelector) {
    const inputMask = new (inputmask__WEBPACK_IMPORTED_MODULE_1___default())('(999) 999_9999', {
      placeholder: '-'
    });
...
/***/ "./src/js/modules/sliderBreakpoint.js":
/*!********************************************!*\
  !*** ./src/js/modules/sliderBreakpoint.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (sliderBreakpoint);
